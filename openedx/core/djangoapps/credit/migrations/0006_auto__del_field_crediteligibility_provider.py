...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field provider on 'CreditCourse'
        m2m_table_name = db.shorten_name('credit_creditcourse_provider')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field provider on 'CreditCourse'
        db.delete_table(db.shorten_name('credit_creditcourse_provider'))
    ...
    models = {
        'credit.creditcourse': {
            ...
            'provider': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['credit.CreditProvider']", 'symmetrical': 'False'})
        },
